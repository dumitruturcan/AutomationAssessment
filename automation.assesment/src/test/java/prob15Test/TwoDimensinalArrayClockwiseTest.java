...
public class TwoDimensinalArrayClockwiseTest extends TwoDimensinalArrayClockwise {
	...
	@Test
	public void TwoDarrayClockwiseSol1() throws IOException {
		...
		assertTrue("input of rotations < 0",validate.isGratherThen(nrOfRotations, -1));
		...
		ioData.write2DarrayList(deleteNullValues(array));
